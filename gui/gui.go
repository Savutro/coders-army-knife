	...
	initialContent = container.NewVBox(
		container.NewHBox(
			container.NewVBox(
				...
				createRow("assets/cube.png", "Calculator", "Perform calculations.", "GO", nil, nil),
				createRow("assets/cube.png", "Encoder", "Encode data.", "GO", nil, nil),
				createRow("assets/cube.png", "Decoder", "Decode data.", "GO", nil, nil),
			),
		),
	)
